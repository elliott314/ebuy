        ...
        <div className="container-fluid bg-dark text-white">
          <div className="row ">
            <div className="col-md-3 py-3">
              ...
              <hr />
              <p>
                E-Buy is the Nepal's first NLP based online shopping website which inspired alot of AI 
                properties to increase the shopping experience.
              </p>
            </div>
            <div className="col-md-3 py-3">
            ...
            <div className="col-md-3 py-3">
              ...
              <address>
                ...
                Bagmati, Kathmandu 
                <br />
                <abbr title="Phone">P:</abbr> +977-9843307164
              </address>
              <div className="h6">Customer Care</div>
              <hr />
              <IconTelephone /> 9844248518
              <br />
              <IconEnvelope /> ashmabhatta10@gmail.com
            </div>
          </div>
        </div>
        <div className="container-fluid bg-secondary text-white text-center">
          <div className="row">
            ...
            <div className="col-md-3 py-2">
              © {new Date().getFullYear()} <br></br>Elishma Technology
            </div>
